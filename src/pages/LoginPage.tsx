...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInError) {
        setError(signInError.message ?? "Ongeldige inloggegevens. Controleer je e-mail en wachtwoord.");
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm bg-slate-800 rounded-2xl p-6 border border-slate-700">
        <h2 className="text-slate-100 text-xl font-bold text-center mb-6">Inloggen</h2>
